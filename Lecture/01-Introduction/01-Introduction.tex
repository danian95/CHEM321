...
\begin{frame}
	...
	\begin{learningobjectives}
		...
		\item Identify necessary procedures for adequate chemical analysis.
	...
	\begin{enumerate}[<+->]
		...
		\item \textbf{Sample Preparation}
			...
			\begin{itemize}
				...
				\item<4> From the textbook, how do we analyze
					\emph{solid} chocolate bars via HPLC
					(High Performance \emph{Liquid}
					Chromatography)
			\end{itemize}
			}
		...
		\item \textbf{Reporting and Interpretation}
			...
			\only<6>{Deliver a clearly written, complete report of
				your results highlighting any
				\alert{limitations} that you attach to them.
