...
\only<+>{%
	...
	Plane-polarized electromagnetic radiation of wavelength $\lambda$, propagating
	along the $x$-axis. The electric field of plane-polarized light is
	confined to a single plane. Ordinary, unpolarized light has electric
	field components in all planes parallel to the direction of travel.
}
\end{frame}
...
\begin{frame}{Molecular Processes}
	\only<+>{%
	...
	\begin{tabularx}{\linewidth} {>{\bfseries}r X}
		...
		Translation & movement of the molecule through space \\
		Rotation & rotation of the molecule \\
		Vibration & vibration of the atoms with respect to each other \\
		Electronic & mutual interactions of the electrons and nuclei
	\end{tabularx}
}
...
\begin{frame}{Absorption of Light}
	\only<+>{%
	\begin{columns}
...
\begin{frame}[t]{Transmittance and Concentration}
	...
	\only<+>{
	\begin{center}
		\includegraphics[width=0.8\linewidth]{Assorted-Beer-Colors.jpg}
	\end{center}

	{\footnotesize https://blog.eckraus.com/how-to-measure-beer-color}}
...
\begin{frame}<article:0>{Beer's Law Examples}
	\only<+>{%
	How will the absorbance change if a solution of the \alert{same color}
	as the light is placed in the cuvette?

	\begin{center}
		\includegraphics[width=\linewidth]{spec/spec0.png}
	\end{center}
}
...
\only<+>{%
	...
	\begin{center}
		\includegraphics[width=\linewidth]{spec/same-empty.png}
	\end{center}
...
\only<+>{%
	How will the absorbance change if a solution of the \alert{opposite
	color} as the light is placed in the cuvette?

	\begin{center}
		\includegraphics[width=\linewidth]{spec/opposite-empty.png}
	\end{center}
}
...
\only<+>{%
	\begin{center}
		\includegraphics[width=\linewidth]{colors.jpg}
	\end{center}
}

\only<+>{%	
	How will the absorbance change with respect to the \alert{path length}
	of the cuvette?

	\begin{center}
		\includegraphics[width=\linewidth]{spec/path1.png}
	\end{center}
}

\only<+>{%
	How will the absorbance change with respect to the \alert{path length}
	of the cuvette if $b$ is doubled?

	\begin{center}
		\includegraphics[width=\linewidth]{spec/path2-empty.png}
	\end{center}
}
...
\only<+>{%
	How will the absorbance change with respect to the \alert{path length}
	of the cuvette if $b$ is tripled?

	\begin{center}
		\includegraphics[width=\linewidth]{spec/path3-empty.png}
	\end{center}
}
...
\only<+>{%
	How will the absorbance change with respect to the \alert{concentration}
	of the solution?

	\begin{center}
		\includegraphics[width=\linewidth]{spec/spec.png}
	\end{center}
}
...
\only<+>{%
	...
	\begin{center}
		\includegraphics[width=\linewidth]{spec/conc1.png}
	\end{center}
...
\only<+>{%
	...
	\begin{center}
		\includegraphics[width=\linewidth]{spec/conc2.png}
	\end{center}
}
\end{frame}
...
\begin{frame}{Where does all this absorbed energy go?}
	\only<+>{%
	\begin{center}
		\includegraphics[width=0.9\linewidth]{relaxation.png}
	\end{center}
}
...
\begin{frame}{Nonradiative Transitions}
...
\begin{frame}{Radiative Transitions (Luminescence)}
	\only<+>{%
	\begin{columns}
...
\begin{frame}{Luminescence Intensity}
	\begin{center}
		\includegraphics[width=0.5\linewidth,trim={0 0 3.3in 1.15in},clip]{luminescence-instrument.png}
	\end{center}
...
\begin{frame}{Use of Chromophores in Analytical Chemistry}
	\only<+>{%
	\begin{itemize}
